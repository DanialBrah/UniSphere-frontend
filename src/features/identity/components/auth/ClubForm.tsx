  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <input {...register('email')} type="email" placeholder="cs.society@university.edu" className={inputClass(!!errors.email)} />
      ...
      <OptionalSection>
        <div>
          ...
          <input {...register('category')} placeholder="Academic / Sports / Arts…" className={inputClass(false)} />
        </div>
        <div>
          <Label>Phone</Label>
        ...
        <div>
          ...
          <textarea {...register('description')} rows={3} placeholder="What is your club about?" className={inputClass(false) + ' resize-none'} />
        </div>
      </OptionalSection>
