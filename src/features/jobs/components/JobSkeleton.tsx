...
/** Matches JobCard's layout so the swap to real content doesn't shift the grid. */
...
export function JobGridSkeleton({ count = 6 }: Readonly<{ count?: number }>) {
  return (
...
export function JobRosterRowSkeleton() {
  return (
