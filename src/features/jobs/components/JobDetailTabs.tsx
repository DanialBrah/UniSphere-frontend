...
export type JobDetailTab = 'details' | 'manage'
...
interface JobDetailTabsProps {
  ...
  /** Only the posting employer or an ADMIN gets the Manage tab. */
  showManage: boolean
}

export function JobDetailTabs({ active, onChange, showManage }: Readonly<JobDetailTabsProps>) {
