...
export type EventDetailTab = 'details' | 'manage'
...
interface EventDetailTabsProps {
  ...
  /** Only the organizer or an ADMIN gets the Manage tab. */
  showManage: boolean
}

export function EventDetailTabs({ active, onChange, showManage }: Readonly<EventDetailTabsProps>) {
