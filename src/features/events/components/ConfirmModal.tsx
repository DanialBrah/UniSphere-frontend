 ...
 *
 * The repo has no shared modal primitive (`components/ui/` holds only Button, Badge, Logo and
 * PageSpinner) and no cross-feature component imports anywhere; features share types, not UI. This
 * is a local copy, matching the existing precedent in News, Communities and Lost & Found.
 */
