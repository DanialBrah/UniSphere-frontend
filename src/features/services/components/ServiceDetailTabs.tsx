...
export type ServiceDetailTab = 'details' | 'manage'
...
interface ServiceDetailTabsProps {
  active: ServiceDetailTab
  onChange: (tab: ServiceDetailTab) => void
  /** Only the listing's provider or an ADMIN gets the Manage tab. */
  showManage: boolean
}

export function ServiceDetailTabs({ active, onChange, showManage }: Readonly<ServiceDetailTabsProps>) {
