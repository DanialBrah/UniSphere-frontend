 ...
 *
 * A third copy of a component News and Communities each already own. The repo has no shared modal
 * primitive (`components/ui/` holds only Button, Badge, Logo and PageSpinner) and no cross-feature
 * component imports anywhere; features share types, not UI. Following that rather than making
 * Lost & Found the first feature to depend on News's component tree.
 */
